...
def backtracking_lsearch(
    ...
    def _prox(x):
        ...
        x_next = gaussian_cp_posterior_mode(x, hazard_rates, mu0, sigmasq0, step_size)[1]
        return x_next
    ...
    if not accelerated:
        ...
        while True:
            ...
            x_prox = _prox(
                x_next - current_step_size * g_next,
                current_step_size,
            )
